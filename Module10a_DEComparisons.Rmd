...
We have already fit our DESeq2 model, specifing our model as `X`. 

Now have model that considered paired sample since the mouse number was included in the design. Next, look at result using the output of the `resultsNames()` function above. 
```{r Results}
# Comparison <- "condition_Wild_vs_Meta"
