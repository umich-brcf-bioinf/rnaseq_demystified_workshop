...
While not necessary, pre-filtering the count table to exclude genes that were poorly measures helps to not only reduce the size of the DESeq2 object, but also gives you a sense of how many genes were measured at the sequencing depth chosen for your experiment. *TODO: Complete filtering explaination, based on http://bioconductor.org/packages/devel/bioc/vignettes/DESeq2/inst/doc/DESeq2.html#pre-filtering*
```{r PreFilter}
