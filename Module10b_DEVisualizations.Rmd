...
Next we can write out our DE results for the KD and OE comparisons to file. 
```{r DEResults}
...
If we threshold only on significance, we still identify less DE genes than the 6057 identified in the paper. How should we interpret these differences? Are we in danger of missing relevant genes or, due to DESeq2 stringency, are we better protected against irrelevant genes?
