...
The remainder of the workshop is oriented around a standard bulk RNA-seq workflow with the goal of doing differential gene expression analysis between groups of samples.
...
> - mRNA (polyA) prep using a full NextSeq flowcell with single-end 75bp reads for 12 samples. ($4,253.00)
> - mRNA (polyA) prep using a shared NovaSeq flowcell giving 400 million reads for 12 samples. ($3,156.40)

---

These materials have been adapted from materials created by the [Harvard Chan Bioinformatics Core (HBC)](http://bioinformatics.sph.harvard.edu/). These are open access materials distributed under the terms of the [Creative Commons Attribution license (CC BY 4.0)](http://creativecommons.org/licenses/by/4.0/), which permits unrestricted use, distribution, and reproduction in any medium, provided the original author and source are credited.
