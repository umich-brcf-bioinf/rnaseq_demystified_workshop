...
The columns are the samples, clustered by similarity of rlog normalized expression of the top 500 most expressed genes. The rows are genes, clusted by similarity of expression.    

The colors are scaled by the 'distance' between the rows of the input data 
...
> **Note**: Heatmaps are helpful visualizations, especially for sharing an overview of your RNA-seq data. However, the why and how to use them properly can be confusing, such as outlined in [this post](https://www.biostars.org/p/230115/). 
