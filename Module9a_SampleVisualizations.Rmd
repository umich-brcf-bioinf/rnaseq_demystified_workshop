...
The [`pheatmap` function](https://cran.r-project.org/web/packages/pheatmap/pheatmap.pdf) does quite a lot in a single step, including scaling the data by row and clustering both for the samples (columns) and genes (rows). *TODO: Add additional overview of pheatmap/heatmap function?*
...
Looking at the heatmap, we see that samples within the same treatment group cluster together, with the Mov.KD and Irrel samples on the same parent node, fitting our understanding of the experimental design. We also see clusters of genes that appear to have contrasting patterns between the treatment groups, .

> **Note**: Heatmaps are helpful visualizations, especially for sharing an overview of your RNA-seq data. However, the why and how to use them properly can be confusing, such as outlined in the questions and answers in [this biostars post](https://www.biostars.org/p/230115/). 
...
PCA .. *TODO: Add overview from*
[a helpful step by step explaination of PCA](https://blog.bioturing.com/2018/06/14/principal-component-analysis-explained-simply/)

*TODO: Add visualizations from bioturning*

>**Note**: Details regarding PCA are outlined in [a Harvard Chan Bioinformatic Core training module](https://hbctraining.github.io/DGE_workshop/lessons/principal_component_analysis.html) and is based a more thorough description presented in a [StatQuest’s video](https://www.youtube.com/watch?v=_UVHneBUBW0). Additionally, [this TowardsDataScience blog post](https://towardsdatascience.com/principal-component-analysis-3c39fbf5cb9d)
...
Next, we'll generate a customized plot using the `ggplot2` package 
```{r PCArlog4}
