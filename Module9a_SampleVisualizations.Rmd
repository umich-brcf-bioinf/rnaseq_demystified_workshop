...
Next, we'll look at our distributions of raw and normalized counts. First, we need to set up some tables and add the relevant annotations. *TODO: Create plotting code file for learners to copy & paste from?*
```{r RawCountsSetup}
...
Using code from legacy Watermelon pipeline to generate 'pretty' heatmaps. 
```{r PrettyHeatmps}
